...
describe('ingestion-worker private-canary readiness', () => {
  it('checks its production Hyperdrive without an R2 binding, source configuration, or source read', async () => {
    ...
    await expect(probePrivateCanaryReadiness(
      input,
      {
        ...
        HYPERDRIVE: { connectionString: 'postgres://hyperdrive.fixture/ingestion' },
      },
    ...
    expect(hyperdrive.opens).toEqual([{
      connectionString: 'postgres://hyperdrive.fixture/ingestion',
