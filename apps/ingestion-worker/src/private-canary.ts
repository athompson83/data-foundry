...
import type { PrivateCanaryRuntimeEnvironment } from '@data-foundry/private-canary';
...
/**
 * This confirms only the ingestion Worker's bound database capability. It
...
export async function probePrivateCanaryReadiness(
  ...
  try {
    ...
    await assertPrivateCanaryRuntimeBinding('ingestion-worker', (expectedRole) =>
