...
const cleanAliases = () => [
  {
    ...
    locatorValue: '/identifiers/model-a',
  },
];
...
const conflictedAliases = () => [
  ...cleanAliases(),
  {
    ...
    strong: true,
    locatorType: 'JSON_POINTER' as never,
    locatorValue: '/identifiers/model-b',
  },
];
...
beforeAll(async () => {
  ...
  const [record] = await factory.driver.query<{ id: string }>(
    `INSERT INTO source_records
     ...
     VALUES ($1, $2, 'judgment-history-probe-0001', 'products', 'equipment_model', '{}'::jsonb,
             '{}'::jsonb, 0.9, 'test')
     RETURNING id`,
