# Multi-Dataset Machine-Data Direction Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Make the Product Owner's multi-dataset machine-data, portfolio expansion, and capability-based hostname direction standing repository authority without disrupting the current release path.

**Architecture:** Put concise non-negotiable product rules in `AGENTS.md`, preserve the detailed approved design in the companion spec, amend the active recurring-revenue plan rather than rewriting history, and align executive checklist/progress language after reconciling concurrent source-decision work. Historical evidence remains unchanged.

**Tech Stack:** Markdown repository governance and product documentation; existing repository documentation/governance checks.

**Spec:** `docs/superpowers/specs/2026-09-16-multi-dataset-machine-data-direction-design.md`

## Global Constraints

- HVAC remains the reference vertical and first factory proof, not Data Foundry's product identity.
- Dataset/data-product onboarding is the primary expansion unit; do not require comprehensive industry coverage before monetization.
- Web/API/MCP/exports/crawler channels share canonical truth while retaining independent rights and entitlements.
- Canonical capability hostnames are `data.aroqon.com`, `api.data.aroqon.com`, and `mcp.data.aroqon.com`; verticals belong in paths/configuration rather than long-term per-industry infrastructure hostnames.
- Do not authorize public DNS cutover, source activation, legal acceptance, credential exposure, or payment changes through this documentation work.
- Do not delay UA-002 or the first paid machine-data release.

---

### Task 1: Establish standing agent rules
...
**Files:**
- Modify: `docs/superpowers/plans/2026-09-08-recurring-revenue-platform.md`
...
- [ ] Add or amend acceptance language so subsequent compatible datasets are expected to onboard primarily through configuration/mapping/validation rather than separate infrastructure.
- [ ] Record capability-based hostname preparation as a standing direction without marking provider DNS/routes live.
- [ ] Preserve current UA-001/UA-002 evidence and blockers exactly; do not overwrite source or database facts with strategy language.

### Task 4: Repository-wide contradiction scan and verification

**Files:**
- Modify only active/canonical documents proven contradictory by the scan.
- Do not modify historical evidence solely because it contains superseded language.
