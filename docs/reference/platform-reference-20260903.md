# Historical platform reference (main 0ae6c7a)

Preserved during reconciliation of README PR #29. Deployment counts and provider observations below are historical; follow docs/owner-actions/cloudflare-deployment.md and the current checklist for operational authority.
